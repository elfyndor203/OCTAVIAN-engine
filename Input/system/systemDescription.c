...
void system_register_INPUT() {
    eOCT_fieldRequest key = {
        ...
        .optional = false,
        .cacheLocation = &iOCT_inputSystem_inst.keyCache
    };
    eOCT_fieldRequest keyPress = {
        .name = "glfwKeyPress",
        .type = eOCT_DATATYPE_BOOL,
        .optional = false,
        .cacheLocation = &iOCT_inputSystem_inst.keyPressCache
    };
    eOCT_fieldRequest keyRelease = {
        .name = "glfwKeyRelease",
        .type = eOCT_DATATYPE_BOOL,
        .optional = false,
        .cacheLocation = &iOCT_inputSystem_inst.keyReleaseCache
    };
    eOCT_fieldRequest mouseButton = {
        .name = "glfwMouseButton",
        .type = eOCT_DATATYPE_INT64,
        .optional = false,
        .cacheLocation = &iOCT_inputSystem_inst.mouseButtonCache
    };
    eOCT_fieldRequest mouseButtonPress = {
        .name = "glfwMouseButtonPress",
        .type = eOCT_DATATYPE_BOOL,
        .optional = false,
        .cacheLocation = &iOCT_inputSystem_inst.mouseButtonPressCache
    };
    eOCT_fieldRequest mouseButtonRelease = {
        .name = "glfwMouseButtonRelease",
        .type = eOCT_DATATYPE_BOOL,
        .optional = false,
        .cacheLocation = &iOCT_inputSystem_inst.mouseButtonReleaseCache
    };
    eOCT_fieldRequest mouseMoveX = {
        .name = "glfwMouseXPos",
        .type = eOCT_DATATYPE_FLOAT32,
        .optional = false,
        .cacheLocation = &iOCT_inputSystem_inst.mousePositionXCache
    };
    eOCT_fieldRequest mouseMoveY = {
        .name = "glfwMouseYPos",
        .type = eOCT_DATATYPE_FLOAT32,
        .optional = false,
        .cacheLocation = &iOCT_inputSystem_inst.mousePositionYCache
    };
